...
ALLOWED_HOSTS = ['3.14.201.123','myluxuryfruit.store','127.0.0.1']
# 3.14~ 가 내 주소
# 숫자로 하면 힘드니까 my~로도 접근할 수 있는 것임.
...
# 장고는 기본적으로 user,group 테이블?을 제공하기 떄문에
# 새로 만든 user 모델로 다시 설정해서 장고한테 알려줘야 함.
...
REST_AUTH = {
    ...
    # 원래 제공된 것 대신에 우리가 만든 것을 사용하고자 함.
...
# 저장 안하면 invalid syntax가 왜 발생하는지?
